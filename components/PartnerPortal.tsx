...
import { Building2, ArrowLeft, Lock, UserPlus, User, LogOut, ClipboardList, UploadCloud, FileSpreadsheet } from 'lucide-react';
import { Button } from './Button';
import { Exercise, NeuroType, Situation, PartnerAccount } from '../types';
import { apiClient } from '../services/apiClient';
import { PARTNER_CONTENT_IMAGE_URL } from '../constants';
...
export const PartnerPortal: React.FC<{ onBack: () => void }> = ({ onBack }) => {
